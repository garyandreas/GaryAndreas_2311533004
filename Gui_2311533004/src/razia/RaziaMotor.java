...
public class RaziaMotor extends JFrame {
	...
	public RaziaMotor() {
		...
		lblNewLabel_3.setBounds(21, 125, 58, 14);
		...
		CBSIM.setBounds(89, 121, 81, 22);
		contentPane.add(CBSIM);
		
		JLabel lblinfo = new JLabel("");
		lblinfo.setHorizontalAlignment(SwingConstants.CENTER);
		lblinfo.setForeground(new Color(255, 255, 255));
		lblinfo.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 14));
